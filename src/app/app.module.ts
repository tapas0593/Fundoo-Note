...
import { UpdateNoteService } from './service/update-note.service';
...
@NgModule({
  ...
  providers: [UserService, LabelService, NoteService, UpdateNoteService, ViewService, CollaboratorService],
